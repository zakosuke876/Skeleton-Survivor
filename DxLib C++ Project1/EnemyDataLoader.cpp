...
bool EnemyDataLoader::LoadNormal(EnemyStatus& outData) {

	return LoadData("Data/EnemyNormalData.json", "Skeleton_Normal", outData);
}

bool EnemyDataLoader::LoadWarrior(EnemyStatus& outData) {

	return LoadData("Data/EnemyWarriorData.json", "Skeleton_Warrior", outData);
}

bool EnemyDataLoader::LoadData(const char* jsonPath, const char* enemyKey, EnemyStatus& outData) {
...
/*bool EnemyDataLoader::LoadWarriorUnique(SkeletonWarriorStatus& outData) {
